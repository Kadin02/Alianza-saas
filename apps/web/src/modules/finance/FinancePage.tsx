...
import { Banknote, FileText, Plus, Receipt } from "lucide-react"
                ...
                <tbody className="divide-y divide-surface-container-low">
                  {charges.map((charge) => (
                    ...
                    >
                      ...
                      <td className="px-3 text-body-sm text-on-surface">{charge.description}</td>
                      <td className="px-3 text-body-sm text-on-surface-variant">{formatDate(charge.due_date)}</td>
